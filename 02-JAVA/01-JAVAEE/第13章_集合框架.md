...
<img src="https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155893.png" alt="第3阶段：Java高级应用-第12章" style="zoom:50%;" />
...
<img src="https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155895.png" alt="image-20220523190743146" style="zoom: 67%;" />
...
![bba29989bc48e45feaccb53ad626dc0](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311141919039.png)

- 简图1：**Collection接口继承树**

<img src="https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155897.png" alt="image-20220407203244029" style="zoom: 67%;" />

- 简图2：**Map接口继承树**

<img src="https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155898.png" alt="image-20220407203412665" style="zoom: 67%;" />

### 1.4 集合的使用场景

![image-20220407202630027](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155899.png)

![第12章_集合的使用场景](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155900.png)
...
（1）add(E obj)：添加元素对象到当前集合中，如果添加的是一个数组，当做一个元素填充进去
...
![](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155901.png)

### 2.2 判断

（3）int size()：获取当前集合中实际存储的元素个数
（4）boolean isEmpty()：判断当前集合是否为空集合
（5）boolean contains(Object obj)：判断当前集合中是否存在一个与obj对象equals返回true的元素，如果判断自定义类的话，需要重新定义equals方法。
（6）boolean containsAll(Collection coll)：判断coll集合中的元素是否在当前集合中都存在。即coll集合是否是当前集合的“子集”
（7）boolean equals(Object obj)：判断当前集合与obj是否相等；很少使用这个方法
...
（8）void clear()：清空集合元素，打印sizeof为0，非空指针
...
数组和几何之间的转换：数组---->集合，调用Arrays的静态方法asList（Object。。。objs） 
...
public class TestCollectionContains {
    ...
    public void test01() {
      ...
      @Test
    public void test6(){
        Integer[] arr = new Integer[]{1,2,3};//包装类
        ...
        List list1 = Arrays.asList(arr1);//自动装箱整个int数组作为一个元素，
...
向collection中添加元素的要求是：

要求元素所属的类一定要重写equals（）！！！！！！

原因：

因为collection中的方法（比如：contains（）/remove（））在使用时，要调用元素所在类的equals（）。
...
public class TestIterator {
    ...
    public void test02(){
        ...
        while(iterator.hasNext()) {//判断是否还有元素可迭代
            System.out.println(iterator.next());//取出下一个元素，正确的 循环
        }
    }
}
...
![image-20220407235130988](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155902.png)
...
![image-20220128010114124](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155903.png)
...
![image-1563549818689](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155904.png)
...
- Arrays.asList(…) 方法返回的 List 集合，既不是 ArrayList 实例，也不是 Vector 实例。 Arrays.asList(…) 返回值是一个固定长度的 List 集合
  ...
  ![image-20220408210743342](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155905.png)

### 4.4 List的实现类之二：LinkedList

- 对于频繁的插入或删除元素的操作，建议使用LinkedList类，效率较高。这是由底层采用链表（双向链表）结构存储数据决定的。

![image-20220408225615829](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155906.png)
...
* 代码实现，效果如图所示：
  ...
  ![image-1559890098509](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155907.png)
...
![image-1559896150606](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155908.png)
...
<img src="https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155909.png" alt="image-20220408235936404" style="zoom:67%;" />
...
- Map接口的常用实现类：`HashMap`、`LinkedHashMap`、`TreeMap`和``Properties`。其中，HashMap是 Map 接口使用`频率最高`的实现类。
  ...
  <img src="https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155910.png" alt="image-20220409001015034" style="zoom:67%;" />

### 6.2 Map中key-value特点

这里主要以HashMap为例说明。HashMap中存储的key、value的特点如下：

<img src="https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155911.png" alt="image-20220409001213720" style="zoom:67%;" />

- Map 中的 `key用Set来存放`，`不允许重复`，即同一个 Map 对象所对应的类，须重写hashCode()和equals()方法

  <img src="https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155912.png" alt="image-20220514190412763" style="zoom:67%;" />
...
![image-20220914190805362](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155913.png)
...
![img](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155914.png)
...
![image-20220409003002526](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155915.png)
...
![image-20220409011625061](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155916.png)
...
![image-20220915002714578](https://raw.githubusercontent.com/sameal153/PicturePool/master/img/202311092155917.png)
